...
metrics["opcounters.insert"] =  {id:"103:Inserts/Sec:7",ratio:true}; // # of inserts per second (* means replicated op).
metrics["opcounters.query"] =  {id:"29:Queries/Sec:7",ratio:true}; // # of queries per second.
metrics["opcounters.update"] =  {id:"186:Updates/Sec:7",ratio:true}; // # of updates per second.
metrics["opcounters.delete"] =  {id:"214:Deletes/Sec:7",ratio:true}; // # of deletes per second.
metrics["opcounters.getmore"] =  {id:"183:Get mores/Sec (cursor batch):7",ratio:true};     // # of get mores (cursor batch) per second.
metrics["opcounters.command"] = {id:"55:Commands/Sec:7",ratio:true}; // # of commands per second, on a slave its local|replicated.
metrics["connections.current"] = {id:"106:Open connections:7",ratio:false}; // Number of open connections.
metrics["extra_info.page_faults"] =  {id:"175:Page Faults/Sec:7",ratio:true}; // # of pages faults per sec (linux only).
metrics["backgroundFlushing.flushes"] =  {id:"189:Fsync flushes/Sec:7",ratio:true}; // # of fsync flushes per second.
metrics["globalLock.activeClients.total"] =  {id:"139:Active clients (read and write):7",ratio:false}; // Active clients (read and write).
metrics["globalLock.currentQueue.total"] =  {id:"155:Queued Operations (waiting for the global lock):7",ratio:false}; // The current number of operations queued waiting for the global lock.
metrics["network.bytesIn"] =  {id:"14:Network traffic in:7",ratio:true}; // Network traffic in - bits.
metrics["network.bytesOut"] =  {id:"113:Network traffic out:7",ratio:true}; // Network traffic out - bits.
metrics["mem.mapped"] =  {id:"180:Data mmaped:7",ratio:false}; // Amount of data mmaped (total data size) megabytes.
metrics["mem.virtual"] =  {id:"22:Process Virtual size:7",ratio:false}; // Virtual size of process in megabytes.
metrics["mem.resident"] = {id:"19:Process Resident size:7",ratio:false}; // Resident size of process in megabytes.
